		...
		return {
			...
			themeVariables: dark
				? {
						...
						tertiaryColor: '#171107',
						tertiaryTextColor: '#cbd5c4',
						tertiaryBorderColor: '#3a2e1c',
						lineColor: '#6b7a5f',
						textColor: '#e2ede2',
						mainBkg: '#171107',
						nodeBorder: '#4ade80',
						...
						commitLabelBackground: 'rgba(23, 17, 7, 0.92)',
