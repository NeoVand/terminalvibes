		...
		return {
			...
			themeVariables: dark
				? {
						...
						tertiaryColor: '#1f1811',
						tertiaryTextColor: '#cbd5c4',
						tertiaryBorderColor: '#453828',
						lineColor: '#6b7a5f',
						textColor: '#e2ede2',
						mainBkg: '#1f1811',
						nodeBorder: '#4ade80',
						clusterBkg: '#19130b',
						clusterBorder: '#453828',
						titleColor: '#e2ede2',
						edgeLabelBackground: '#1f1811',
						nodeTextColor: '#e2ede2',
						// sequenceDiagram
						actorBkg: '#1f1811',
						actorTextColor: '#cbd5c4',
						actorBorder: '#453828',
						actorLineColor: '#453828',
						noteBkgColor: 'transparent',
						noteTextColor: '#64748b',
						noteBorderColor: 'transparent',
						signalColor: '#5c6b52',
						signalTextColor: '#9caf8e',
						activationBkgColor: '#1f1811',
						...
						commitLabelBackground: 'rgba(31, 24, 17, 0.92)',
				...
				: {
						...
						tertiaryBorderColor: '#d5cab5',
						lineColor: '#9aab90',
						textColor: '#24301f',
						mainBkg: '#f7f3ea',
						nodeBorder: '#86d8a2',
						clusterBkg: '#f7f3ea',
						clusterBorder: '#e6ddcc',
						titleColor: '#24301f',
						...
						actorBorder: '#d5cab5',
						actorLineColor: '#d5cab5',
						noteBkgColor: 'transparent',
						noteTextColor: '#94a3b8',
						noteBorderColor: 'transparent',
						signalColor: '#9aab90',
						signalTextColor: '#6b7a5f',
						activationBkgColor: '#f1ece1',
